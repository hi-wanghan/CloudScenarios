...
namespace AwsGlacierSample
{
    class Program
    {
        ...
        static string vaultName = "hanvaultforglaciertest";

        // Set the file path for the file you want to upload here.
        static string filePath = "C:\\install.exe";

        // Set the file path for the archive to be saved after download.
        static string downloadFilePath = "C:\\WATK";
        ...
        static void Main(string[] args)
        {
            ...
            {
                using (manager = new ArchiveTransferManager(Amazon.RegionEndpoint.USWest2))
                {
                    try
                    {
                        manager.DeleteArchive(vaultName, "p2Wq8P8AZph-64Rr5v4_mQM-3sPBvKKfGRWdgHhK-bQbBSg");
